...
class ProcessProtocol(asyncio.SubprocessProtocol):
    ...
    def pipe_data_received(self, fd, data):
        ...
        if b"collector dnstap unix receiver - incoming framestream initialized" in data:
...
class TestDnstap(unittest.TestCase):
    ...
    def test_stdout_recv(self):
        ...
        async def run():
            ...
            args = ( "sudo", "-u", COLLECTOR_USER, "-s", "./go-dnslogger", "-config", "./testsdata/config_stdout_dnstapunix.yml",)
